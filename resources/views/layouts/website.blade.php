...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('website/ss/jquery-ui.css')}}">
            ...
            <nav class="site-navigation" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0">
				...
				@foreach($categories as $category)
					<li><a href="{{ route('category.posts', ['slug'=>$category->slug]) }}">{{ $category->name }}</a></li>
				@endforeach
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-3 ml-auto">
			...
			@foreach($categories as $category)
              <li><a href="{{ route('website.category') }}">{{ $category->name }}</a></li>
			@endforeach  
            </ul>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This Blog Site is developed with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Monsurul Hassan</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
        </div>

			  ...
			  <div class="col-sm-12">
				...
				<form action="{{ route('tag.update', [$tag->id]) }}" method="post">
				  ...
				  <div class="form-group">
					...
					<input type="text" name="name" class="form-control" id="exampleFormControlInput1" placeholder="Tag name" value="{{ $tag->name }}">
				  </div>
				  
				  <div class="form-group">
					<label for="description">Description</label>
					<textarea class="form-control" name="description" id="description" rows="4" placeholder="Tag description...">{{ $tag->description }}</textarea>
				  </div>

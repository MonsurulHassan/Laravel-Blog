            ...
            <div class="entry2">
              ...
              <div class="excerpt">
				  ...
				  <div class="post-meta align-items-center text-left clearfix">
					...
					<span>&nbsp;-&nbsp; {{ $RecentPost->created_at->format('M d, Y') }} at {{ $RecentPost->created_at->format('h:i a') }}</span>
				  </div>
					<p> {!! Illuminate\Support\Str::of($RecentPost->description)->limit(200, ' (...) ') !!}</p>
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
          <div class="col-md-5 order-md-2">
            <a href="single.html" class="hentry img-1 h-100 gradient" style="background-image: url({{asset('$cat_tech->post->image')}})">
              <span class="post-category text-white bg-danger">{{ $cat_tech->name }}</span>
              <div class="text">
                <h2> sss </h2>
          ...
          <div class="col-md-7">
            ...
            <div class="two-col d-block d-md-flex">
              <a href="single.html" class="hentry v-height img-2 gradient" style="background-image: url({{asset('webiste/images/img_2.jpg')}});">
